...
import { ButtonView, DropdownButtonView, Model, createDropdown, addListToDropdown } from 'ckeditor5'
import { CKEditorError, Collection } from 'ckeditor5'
import VideoResizeEditing from './videoresizeediting'

const RESIZE_ICONS = {
  small: icons.IconObjectSizeSmall,
  medium: icons.IconObjectSizeMedium,
  large: icons.IconObjectSizeLarge,
  original: icons.IconObjectSizeFull,
}
