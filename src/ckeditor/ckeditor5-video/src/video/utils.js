import { isWidget, toWidget } from 'ckeditor5'
// import { findOptimalInsertionPosition } from '../../../../../node_modules/.vite/deps/@ckeditor_ckeditor5-widget_src_utils.js'
...
export function insertVideo(model, attributes = {}, insertPosition = null) {
  model.change((writer) => {
    ...
    const insertAtSelection =
      insertPosition || findOptimalInsertionPosition(model.document.selection, model)
