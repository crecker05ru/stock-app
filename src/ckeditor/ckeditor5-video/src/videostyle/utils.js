...
const defaultStyles = {
  ...
  full: {
    ...
    icon: icons.IconObjectFullWidth,
    isDefault: true,
  },
...
const defaultIcons = {
  full: icons.IconObjectFullWidth,
  left: icons.IconObjectLeft,
  right: icons.IconObjectRight,
  center: icons.IconObjectCenter,
}
